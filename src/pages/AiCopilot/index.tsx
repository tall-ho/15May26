...
export default function AiCopilot() {
  ...
  const [messages, setMessages] = useState([
    { id: 1, role: 'ai', text: 'สวัสดีค่ะ! ฉันคือ T All BOT ผู้ช่วยอัจฉริยะของคุณในระบบ SMART LAW. วันนี้มีข้อกฎหมายหรือเอกสารส่วนไหนที่คุณต้องการให้ฉันช่วยวิเคราะห์ไหมคะ?', timestamp: '08:00 AM' }
  ]);
