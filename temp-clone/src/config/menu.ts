...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'copilot', path: '/copilot', name: 'AI TALENT COPILOT', icon: BrainCircuit, category: 'TOP' },
  { id: 'calendar', path: '/law-calendar', name: 'CALENDAR', icon: Calendar, category: 'TOP' },
  ...
  { 
    ...
    subItems: [
      ...
      { id: 'disc_actions', name: 'DISCIPLINARY ACTIONS', path: '/disciplinary/actions' },
      { id: 'disc_investigation', name: 'INVESTIGATION & PUNISHMENT', path: '/disciplinary/investigation' }
    ]
  },
  { 
    id: 'time_attendance', 
  ...
  { 
    ...
    category: 'CORE HR & OPERATIONS',
    subItems: [
      { id: 'leave_requests', name: 'LEAVE REQUESTS', path: '/leave-management/requests' },
      { id: 'leave_balances', name: 'LEAVE BALANCES', path: '/leave-management/balances' },
  ...
  { 
    ...
    category: 'CORE HR & OPERATIONS',
    subItems: [
      { id: 'payroll_salary', name: 'SALARY MANAGEMENT', path: '/payroll/salary' },
      { id: 'payroll_payslips', name: 'PAYSLIPS', path: '/payroll/payslips' },
  ...
  { 
    ...
    subItems: [
      ...
      { id: 'perf_evaluation', name: 'EVALUATION', path: '/performance/evaluation' }
    ]
  },
  { 
    id: 'talent_planning', 
